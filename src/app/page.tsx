...
import LoopBackground from "@/components/ui/LoopBackground";
...
export default function Home() {
  return (
    <div className="relative isolate flex min-h-screen flex-col overflow-hidden">
      <LoopBackground className="opacity-40"/>
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="flex-1">
          <section className="mx-auto max-w-6xl px-4 py-24 text-center sm:px-6 lg:px-8">
            <span className="inline-block rounded-full bg--accent-soft px-3 py-1 text-sm font-medium text-primary">
